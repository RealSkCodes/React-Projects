export default async function handler(req, res) {
  ...
  try {
    ...
    res.setHeader("Access-Control-Allow-Origin", "*") // Allows requests from all domains
    res.setHeader("Access-Control-Allow-Methods", "GET, OPTIONS") // Allows specific methods
